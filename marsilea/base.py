...
class ClusterBoard(WhiteBoard):
    ...
    def add_dendrogram(self, side, method=None, metric=None, linkage=None,
                       ...
                       show=True, name=None, size=0.5, pad=0., centroid_func=None):
        ...
        centroid_func: callable
            ...
            of columns in the input, representing the centroid.
        ...
        if side in ["right", "left"]:
            ...
            deform.set_cluster(row=True, method=method, metric=metric,
                               linkage=linkage, use_meta=add_meta, centroid_func=centroid_func)
        else:
            den_options['pos'] = "col"
